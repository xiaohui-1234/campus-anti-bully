    ...
    public ConfigVO getConfig() {
        return ConfigVO.builder()
                ...
                .minio(ConfigVO.Minio.builder()
                        .endpoint(properties.getMinio().getEffectiveInternalEndpoint())
                        .internalEndpoint(properties.getMinio().getEffectiveInternalEndpoint())
                        .publicEndpoint(properties.getMinio().getEffectivePublicEndpoint())
                        .uploadEndpoint(properties.getMinio().getEffectiveUploadEndpoint())
